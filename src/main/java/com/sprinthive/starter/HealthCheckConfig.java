...
public class HealthCheckConfig {
    ...
    @Bean
    public HealthCheckService healthCheckService(PropsService propsService,
                                                 AppEventRepository appEventRepository,
                                                 HealthCheckProducer healthCheckProducer) {
        return new HealthCheckService(propsService, appEventRepository, healthCheckProducer);
    }
}
